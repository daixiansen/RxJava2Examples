...
public class RxNetworkActivity extends RxOperatorBaseActivity {
    ...
    protected void doSomething() {
        ...
        Observable<MobileAddress> mobileAddressObservable = Rx2AndroidNetworking.get("http://api.avatardata.cn/MobilePlace/LookUp?key=ec47b85086be4dc8b5d941f5abd37a4e&mobileNumber=13021671512")
                .build()
                .getObjectObservable(MobileAddress.class);

        mobileAddressObservable.observeOn(AndroidSchedulers.mainThread()) // 为doOnNext() 指定在主线程，否则报错

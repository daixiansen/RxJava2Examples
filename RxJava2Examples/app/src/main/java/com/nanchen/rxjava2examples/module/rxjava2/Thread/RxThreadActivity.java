    ...
    protected void doSomething() {
        Observable.create(new ObservableOnSubscribe<Integer>() {
            ...
            public String apply(@NonNull Integer integer) throws Exception {
                Log.e(TAG, "map thread is : " + Thread.currentThread().getName());
                return "我是转换map" + integer ;
            }
        }).subscribeOn(Schedulers.newThread())
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .doOnNext(new Consumer<String>() {
                    ...
                    public void accept(@NonNull String s) throws Exception {
                        Log.e(TAG, s + "   After observeOn(mainThread)，Current thread is " + Thread.currentThread().getName());
                    }
                })
                .observeOn(Schedulers.io())
                .subscribe(new Consumer<String>() {
                    @Override
                    public void accept(@NonNull String s) throws Exception {
                        Log.e(TAG, s + "   After observeOn(io)，Current thread is " + Thread.currentThread().getName());
                    }
                });
    }
}
